...
public class HttpTaskManagerPrioritizedTest {
    ...
    public void beforeEach() throws IOException {
        ...
        Subtask subtask8 = new Subtask("Подзадача №8", "ОК-008", epic4.getId(), 10, Managers.stringToDate("2024-01-01 23:00"));
    ...
    public void checkGetTasks() throws IOException, InterruptedException {
        ...
        System.out.println(">> Получить приоритезированный список задач");
